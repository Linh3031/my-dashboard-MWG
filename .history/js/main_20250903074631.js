...
document.addEventListener('DOMContentLoaded', function () {
    const app = {
        ...
        applyHealthSectionFiltersAndRender() {
            ...
            ui.renderLuykeQdcTable(supermarketReport, numDays, qdcTableGroups);
        ...
        applySknvFiltersAndRender() {
            ...
            const qdcTableGroups = {
                PIN_SDP: { codes: ['12'], name: 'Pin SDP', colorClass: 'qdc-group-ict' },
                TAI_NGHE_BLT: { codes: ['3346', '4540'], name: 'Tai nghe BLT', colorClass: 'qdc-group-ict' },
                DONG_HO: { codes: ['4059', '4060', '4061', '4062', '4063', '4064', '4070'], name: 'Đồng hồ', colorClass: 'qdc-group-ict' },
                CAMERA: { codes: ['4219', '6479'], name: 'Camera', colorClass: 'qdc-group-ict' },
                LOA: { codes: ['1031', '1351', '4779'], name: 'Loa', colorClass: 'qdc-group-ict' },
                UDDD: { codes: ['571', '611'], name: 'UDDĐ', colorClass: 'qdc-group-vas' },
                BAO_HIEM: { codes: ['4479', '4499'], name: 'Bảo hiểm', colorClass: 'qdc-group-vas' },
                NOI_COM: { codes: ['4157', '4158'], name: 'Nồi cơm điện tử + cao tần', colorClass: 'qdc-group-giadung' },
                NOI_CHIEN: { codes: ['4099'], name: 'Nồi chiên', colorClass: 'qdc-group-giadung' },
                MAY_LOC_NUOC: { codes: ['4171', '4172'], name: 'Máy lọc nước', colorClass: 'qdc-group-giadung' },
                ROBOT_HB: { codes: ['4439'], name: 'Robot hút bụi', colorClass: 'qdc-group-giadung' },
                SIM_ONLINE: { codes: ['1891'], name: 'SIM', colorClass: 'qdc-group-sim' }
            };
            ui.displaySknvReport(filteredReport, allDepartmentAverages, qdcTableGroups);
        ...
        getLuykeGoalSettings(selectedWarehouse = null) {
            ...
            if (selectedWarehouse && appState.luykeGoalSettings[selectedWarehouse]) {
                ...
                // Aggregate all goals if no specific warehouse is selected
        ...
        applyKpiCardColors(prefix) {
            ...
            for (let i = 1; i <= 4; i++) {
                ...
                const card = document.getElementById(`${prefix === 'luyke' ? 'luyke' : 'realtime'}-kpi-card-${i}`);
